...
//     const vidURL = useMemo(() => URL.createObjectURL(mediaFiles?.[0]), [mediaFiles]);
...
//         if (!mediaFiles.length) return toast.error('No media selected.');
//         setLoading(true);
...
//                 <h2 className="text-2xl font-semibold text-center">Compose Post</h2>
...
//                                     alt={`media-${idx}`}
//                                     className="w-64 shrink-0 aspect-video bg-black rounded-md"
//                                 />
//                             ))
//                     }
//                 </div>
